...
namespace ROSNOETIC
{
    ...
    {
        std::string config_file_name,lidar_topic,imu_topic, odom_topic;
        ...
        odometry_subscriber = nh.subscribe(odom_topic,100,&IESKFFrontEndWrapper::odometryMsgCallBack,this);
        // 读取雷达类型
        int lidar_type = 0;
